...
/** @type {string} */
const CACHE_VERSION = '1775909817|6830286951';
/** @type {string} */
const CACHE_PREFIX = 'effectinator-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'effectinator.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["effectinator.html","effectinator.js","effectinator.offline.html","effectinator.icon.png","effectinator.apple-touch-icon.png","effectinator.audio.worklet.js","effectinator.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["effectinator.wasm","effectinator.pck"];
